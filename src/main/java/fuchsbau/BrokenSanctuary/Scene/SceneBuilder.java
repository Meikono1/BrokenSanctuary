package fuchsbau.BrokenSanctuary.Scene;
...
public class SceneBuilder {
    ...
    public BorderPane buildBorderPane(Node top, Node right, Node left, Node buttom) {
    ...
    public BorderPane makePlayerInventory(TreeMap<Item, Integer> itemMap, Armor head, Armor chest, Armor arms, Armor pants, Armor boots, Weapon weapon) {
        ...
        option.setOnMouseClicked(event -> {
            Main.getStage().setTitle("BrokenSanctuary");
    ...
    private VBox createEquipItem(Item item) {
        ...
        if (item instanceof Armor) {
            ...
            unten = makeText("  " + armor.armor + ",   " + armor.quality + ",   " + armor.durability);
        } else {
    ...
    /***
     * Creating a Label dependent on the Widthpropertie of the first buttonrow
     * @param s String to insert
     * @return Label for Buttonrow
     */
    public Label makeLabel(String s) {
        Label label = new Label();
        label.prefWidthProperty().bind(Bindings.divide(firstButtonrow.widthProperty(), 7));
    ...
    public TextField createTextfield() {
        ...
        textField.prefWidthProperty().bind(Bindings.divide(firstButtonrow.widthProperty(), 7));
        return textField;
    }
