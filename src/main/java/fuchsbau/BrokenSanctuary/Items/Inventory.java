...
import fuchsbau.BrokenSanctuary.Items.Gear.Boots.ClothBoots;
import fuchsbau.BrokenSanctuary.Items.Gear.Boots.NoShoos;
import fuchsbau.BrokenSanctuary.Items.Gear.Head.ClothHelm;
import fuchsbau.BrokenSanctuary.Items.Gear.Head.NoHat;
import fuchsbau.BrokenSanctuary.Items.Gear.LowerBody.ClothPants;
import fuchsbau.BrokenSanctuary.Items.Gear.LowerBody.NoPants;
import fuchsbau.BrokenSanctuary.Items.Gear.UpperBody.ClothChest;
import fuchsbau.BrokenSanctuary.Items.Gear.UpperBody.NoChest;
import fuchsbau.BrokenSanctuary.Items.Weapons.Unarmed;
import fuchsbau.BrokenSanctuary.Items.Weapons.Weapon;
...
public class Inventory {
    ...
    public String getStats() {
        ...
        int qualitaet = head.quality + chest.quality + boots.quality + arms.quality + pants.quality;
        double zustand = head.durability + chest.durability + boots.durability + arms.durability + pants.durability;
